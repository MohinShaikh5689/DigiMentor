export  const IconComponent = ({ name, size = 24 }: { name: string; size?: number }) => {
    const icons = {
      desktop: (
      ...
      award: (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
          <path d="M5,16L3,5L8.5,12L12,7L15.5,12L21,5L19,16H5M19,19A1,1 0 0,1 18,20H6A1,1 0 0,1 5,19V18H19V19Z"/>
        </svg>
      ),
      star: (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
